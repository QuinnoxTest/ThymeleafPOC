...
// code to check if introductory and education section are empty
  ...
  /*function checkEmpty(studentEmailId)
  { 
	  var formValue = document.getElementById("previewForm") ;
	  ...
	  var checked_option_radio = $('input[name=gender]:checked').val() ;
	  
	  var schoolName = $("#schoolName").val() ; 
	  var h_from_gpa = $("#schoolGpaFrom").val() ;
	  var h_to_gpa = $("#schoolGpaTo").val() ; 
	  var schoolState = $("#schoolState").val() ; 
	 
	 
	  if(typeof checked_option_radio === "undefined" || dob === "" || firstName === "" || lastName === "" || zipCode === "" || schoolName === "" || schoolState === "" ||
			  h_from_gpa === "" || h_to_gpa === "") 
	  { 
		  alert("Please fill the Introductory and Education Section") ; 
	  }
