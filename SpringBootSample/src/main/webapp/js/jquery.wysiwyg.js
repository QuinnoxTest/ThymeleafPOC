...
(function( $ )
{
    ...
    $.extend(Wysiwyg, {
        ...
        TOOLBAR : {
            ...
            cut   : { visible : true, tooltip : "Cut" },
            copy  : { visible : true, tooltip : "Copy" },
        ...
        initFrame : function()
        {
            ...
            if ( this.options.css )
            {
                setTimeout(function()
                {
                    if ( self.options.css.constructor == String )
                    {
                        ...
                        $(this.editorDoc)
                                .keyup(function(){ if (self.options.autogrow) self.updateHeight(); });
            ...
            {                      
                ...
                */
                ...
                {
                        var height = $( $(this.editor).document() ).find('body').height() + parseInt( $( $(this.editor).document() ).find('body').css('font-size') ) + 10;
                        if (height < this.options.autogrow_minHeight) { height = this.options.autogrow_minHeight; }
